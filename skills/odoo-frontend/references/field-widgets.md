...
- `addons/web/static/src/views/fields/field.js` — registry, validator, `parseFieldNode`, `getFieldFromRegistry`.
- `addons/web/static/src/views/fields/standard_field_props.js` — standard props.
...
- `addons/web/static/src/views/fields/input_field_hook.js` — `useInputField`.
